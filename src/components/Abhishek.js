                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      I believe in mixing a variety of therapeutic approaches to
                      come up with a blend of a flavourful alliance. All my
                      interventions are client-centric as I feel that no concern
                      is similar to another hence there should be an eclectic
                      style of intervention. The destination should be
                      addressing clients’ needs and concerns.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      Counseling for me is like a lifestyle, it's food for the
                      mind. The way we need to address an open wound and make
                      changes in our life to heal it, likewise for concerns of
                      our mind.
                    </p>
                  </div>
                </div>
              ...
              <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      My life revolves around the philosophy of being the change
                      I wish to see in the world. Hence, my innate wish and need
                      to bring about a change in my life as well as others’
                      drove me to study psychology. Intrigued by how everything
                      is connected; the mind, the body, our view of the world,
              ...
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      Counselling is like a journey, and I believe in helping
                      clients be the best version of themselves. My style is
                      client-centric and I use a mix of solution-focused and
                      cognitive behavioral therapy to ease clients’ distress,
                      ultimately helping them overcome their embroilment and
                      pushing them to become the best version of themselves.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      The relief which a client gets gives me the biggest
                      satisfaction and pushes me every day to work hard and dive
                      deeper into what I do. A smile on the face of a depressed
                      client and a relaxed anxious person, in addition to
                      overcoming challenges which we face with ourselves and our
                      healed relationships, lies close to me.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      As said by Wayne Dyer, "If you change the way you look at
                      things, the things you look at change." I believe that
                      stressors can never be eliminated, but how we view them
                      changes the entire story. Whenever I am stuck with a
                      stressor that seems like a block, I turn to my support
                      system, my friends and my family, cry if I feel like it,
                      talk if I want to, and eat delicacies while watching my
                      favourite series.
                    </p>
                  </div>
                </div>
