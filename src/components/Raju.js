      ...
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p class="mb-8 leading-relaxed">B tech in Mechanical Engineering</p>
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="text-center mb-20">
            <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">
              “You are the master of your destiny. You can make your life what
              you want it to be!” -Napoleon Hill
            </h1>
          </div>
          <section class="text-gray-600 body-font">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      ...
                      individual. I borrow ideas and techniques from various
                      schools of thought, and my main approach stems from
                      Rational Emotive Behaviour Therapy, Cognitive Behavioural
                      Therapy and Solution Focussed Approach.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      Counselling is not for people with mental health issues;
                      Counselling is for anyone and everyone who wants to
                      undertake a journey of transformation that helps them
                      realise their own potential, and empowers them to tackle
                      obstacles in their life head-on.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      I chose counselling because I believe that counselling can
                      help change the way we perceive the world, and inculcate a
                      sense of hope and optimism in us, which empowers us to
                      care for our mental well-being for the rest of our lives.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      My style is person-centered as I believe counselling
                      revolves around the needs of each unique individual. I use
                      an eclectic approach with elements of Rational Emotive
              ...
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      All concerns are equally important to me. If I had to
                      choose, I am particularly interested in empowering clients
                      to cope with grief, loss and anger.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      Planning, being organised and prepared for any situation
                      helps me stay relaxed. Spending time with my family and
                      reading a good book is also an instant stress-buster!
                    </p>
                  </div>
                </div>
              </div>
