...
export default function Shailesh() {
  return (
    <>
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="text-center mb-20">
            <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">
              “Help will always be given…to those who ask for it” -Albus
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      My approach to therapy is humanistic as I believe every
                      client is a unique person. I borrow my counselling
                      practices from Solution-Focussed Brief Therapy (SFBT) and
              ...
              <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      I believe counselling is a journey that the client
                      ventures on. There may be different companions
                      (therapists), as well as different roads (therapy styles),
                      but the traveller (client) will figure out a way to reach
                      their destination. The right path and companion will help
                      make this journey a little less difficult and a little
                      more fulfilling.
                    </p>
                  </div>
                </div>
              ...
              <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      “Is it me? … Why me? … “Can I do this?”… “Is it even worth
                      it?” … “Am I enough?” … “I wish it would stop hurting” So
                      many of us have asked ourselves these questions but just
                      couldn’t get the right answer. My calling to counselling
                      stems from the understanding of these shared experiences.
                      We’ve all wanted someone sometime who’d just listen to us,
                      help us make sense of things… someone we could confide in
                      and look for solutions with. Being able to create such a
                      therapeutic space is what drove me toward counselling.{" "}
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      I have an affirmative client-centred style, with
                      therapeutic practices borrowed from solution- focussed,
                      rational-emotive and cognitive-behavioural therapies.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      Stress from daily life can seep into relationships and a
                      person’s overall wellbeing. Navigating through day-to-day
                      challenges, building a queer-affirmative space, being able
                      to resolve relationship conflicts and enhancing overall
                      wellbeing are the concerns close to my heart.
                    </p>
                  </div>
                </div>
              </div>
              <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                ...
                <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p class="leading-relaxed">
                      A cup of hot tea, long walks, occasional good-company and
                      an ear to listen to me are my go-to stress busters.
                    </p>
                  </div>
                </div>
              </div>
